...
function getEmailAddresses(house1, house2) {
  var emailAddress = [house1.currentOwner.email, house2.currentOwner.email];
  return emailAddress;
}

// returns the address for the cheapest house out of the two
function getCheapestAddress(house1, house2) {
  var housePrice1 = house1.price;
  var housePrice2 = house2.price;
  if (housePrice1 < housePrice2) {
